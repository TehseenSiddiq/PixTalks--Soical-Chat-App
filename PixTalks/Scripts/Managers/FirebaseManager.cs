...
public class FirebaseManager : SingletonBehaviour<FirebaseManager> {
    ...
    void Start() {
        ...
        FirebaseApp app = FirebaseApp.Create(new FirebaseOptions()
        {
            DatabaseUrl = "https://unitychatpublicapp.firebaseio.com/",
        });

        FirebaseDatabase.DefaultInstance = app.FirebaseDatabase;
